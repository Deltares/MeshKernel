...
namespace DeltaShell.Plugins.GridEditor.GridGeomStateful.Native
{
    ...
    internal static class GridgeomStatefulDll
    {
        ...
        /// <summary>
        /// Gets the grid state as a <see cref="MeshGeometry"/> structure including cell information
        /// </summary>
        /// <param name="gridStateId">Id of the grid state</param>
        /// <param name="meshGeometryDimensions">Grid dimensions</param>
        /// <param name="meshGeometry">Grid data</param>
        /// <returns>Error code</returns>
        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_find_cells_stateful", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int GetGridStateWithCells([In] ref int gridStateId, [In, Out] ref MeshGeometryDimensions meshGeometryDimensions, [In, Out] ref MeshGeometry meshGeometry);
        ...
        public static extern int GetVertexIndex(ref int gridStateId, ref GeometryListNative geometryListIn, ref double searchRadius, ref int vertexIndex);
        ...
        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_curvilinear_mesh_from_splines_ortho_initialize", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int MakeOrthogonalGridFromSplinesInitialize([In] ref int gridStateId, [In] ref GeometryListNative geometryListNative, [In] ref CurvilinearParametersNative curvilinearParametersNative, [In] ref SplinesToCurvilinearParametersNative splinesToCurvilinearParametersNative);

        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_curvilinear_mesh_from_splines_iteration", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int MakeOrthogonalGridFromSplinesIteration([In] ref int gridStateId, [In,Out] ref int layer);

        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_curvilinear_mesh_from_splines_ortho_refresh_mesh", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int MakeOrthogonalGridFromSplinesRefreshMesh([In] ref int gridStateId);

        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_curvilinear_mesh_from_splines_ortho_delete", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int MakeOrthogonalGridFromSplinesDelete([In] ref int gridStateId);
        ...
        /// <returns></returns>
        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_delete_edge", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int DeleteEdge(ref int gridStateId, ref GeometryListNative geometryListIn, ref double searchRadius);
        ...
        /// <returns>If the operation succeeded</returns>
        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_move_node", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int MoveVertex(ref int gridStateId, ref GeometryListNative geometryListIn, ref int vertexIndex);
        ...
        /// <returns>If the operation succeeded</returns>
        [DllImport(GridGeomStatefulDllName, EntryPoint = "ggeo_points_in_polygon", CallingConvention = CallingConvention.Cdecl)]
        internal static extern int PointsInPolygon(ref int gridStateId, ref GeometryListNative inputPolygon, ref GeometryListNative inputPoints, ref GeometryListNative selectedPoints);
