...
namespace DeltaShell.Plugins.GridEditor.GridGeomStateful.Api
{
    ...
    public sealed class GridgeomStatefulApi : IGridgeomStatefulApi
    {
        ...
        public DisposableMeshGeometry GetGridStateWithCells(int gridStateId)
        {
            ...
            GridgeomStatefulDll.GetGridStateWithCells(ref gridStateId, ref newMeshDimensions, ref newMeshGeometry);
            ...
            ref CurvilinearParameters curvilinearParameters, ref SplinesToCurvilinearParameters splinesToCurvilinearParameters)
        {
            ...
            var curvilinearParametersNative = curvilinearParameters.ToCurvilinearParametersNative();
            var splinesToCurvilinearParametersNative = splinesToCurvilinearParameters.ToSplinesToCurvilinearParametersNative();
            return GridgeomStatefulDll.MakeOrthogonalGridFromSplinesInitialize(ref gridStateId, ref geometryListNative,
                       ref curvilinearParametersNative, ref splinesToCurvilinearParametersNative) == 0;
        }

        public bool MakeOrthogonalGridFromSplinesIteration(int gridStateId, int layer)
        {
            return GridgeomStatefulDll.MakeOrthogonalGridFromSplinesIteration(ref gridStateId, ref layer) == 0;
        }

        public bool MakeOrthogonalGridFromSplinesRefreshMesh(int gridStateId)
        {
            return GridgeomStatefulDll.MakeOrthogonalGridFromSplinesRefreshMesh(ref gridStateId) == 0;
        }

        public bool MakeOrthogonalGridFromSplinesDelete(int gridStateId)
        {
            return GridgeomStatefulDll.MakeOrthogonalGridFromSplinesDelete(ref gridStateId) == 0;
        }
            ...
            double searchRadius, ref int vertexIndex)
        {
            ...
            return GridgeomStatefulDll.GetVertexIndex(ref gridStateId, ref geometryListNativeIn, ref searchRadius, ref vertexIndex) == 0;
        }

        public bool DeleteEdge(int gridStateId, ref DisposableGeometryList geometryListIn, double searchRadius)
        {
            var geometryListNativeIn = geometryListIn.CreateGeometryListNative();
            return GridgeomStatefulDll.DeleteEdge(ref gridStateId, ref geometryListNativeIn, ref searchRadius) == 0;
        }
        ...
        public bool MoveVertex(int gridGeomId, ref DisposableGeometryList disposableGeometryLisIn, int vertexIndex)
        {
            ...
            return GridgeomStatefulDll.MoveVertex(ref gridGeomId, ref geometryListNativeIn, ref vertexIndex) == 0;
        }
        ...
        public bool PointsInPolygon(int gridGeomId, ref DisposableGeometryList inputPolygon, ref DisposableGeometryList inputPoints, ref DisposableGeometryList selectedPoints)
        {
            ...
            return GridgeomStatefulDll.PointsInPolygon(ref gridGeomId, ref geometryListNativeInputPolygon, ref geometryListNativeinputPoints, ref geometryListNativeSelectedPoints) == 0;
        }
...
ProjectToLandBoundaryOptions projectToLandBoundaryOption,
    ...
    DisposableGeometryList geometryListNativeLandBoundaries)
        ...
        private DisposableMeshGeometry CreateDisposableMeshGeometry(MeshGeometryDimensions newMeshDimensions, MeshGeometry newMeshGeometry, bool addCellInformation = false)
        {
            var disposableMeshGeometry = new DisposableMeshGeometry
            {
