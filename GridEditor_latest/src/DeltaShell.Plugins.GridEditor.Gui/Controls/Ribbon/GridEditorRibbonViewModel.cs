...
namespace DeltaShell.Plugins.GridEditor.Gui.Controls.Ribbon
{
    ...
    public class GridEditorRibbonViewModel : INotifyPropertyChanged, IGridRibbonState
    {
        ...
        public bool HasTwoPolygonsSelected
        {
            get { return Controller.MapInteractor?.PolygonSelections?.Take(2).Count() == 2; }
        }
        ...
        public GenerateGridWorkFlowType SelectedGenerateGridWorkFlowType
        {
            ...
            set
            {
                ...
                OnPropertyChanged(nameof(IsPolygonVisible));
            }
        }
        ...
        {
            get { return SelectedGenerateGridWorkFlowType.GetDescription(); }
        }
        ...
        public bool IsPolygonVisible
        {
            get
            {
                return SelectedGenerateGridWorkFlowType == GenerateGridWorkFlowType.RegularWithPolygon;
            }
        }
        ...
        /// <summary>
        /// Deletes samples in polygons
        /// </summary>
        public ICommand DeleteSamplesInPolygonsCommand { get; private set; }
        ...
        public ICommand MergePolygonsCommand { get; private set; }

        public ICommand SubtractPolygonsCommand { get; private set; }

        public ICommand ClipPolygonsCommand { get; private set; }
        ...
        /// Is the spline tool currently active
        /// </summary>
        public bool SelectToolToolEnabled
        {
            get { return Controller?.SelectedMapToolType == MapToolType.None; }
        }
        ...
        {
            get { return Controller?.SelectedMapToolType == MapToolType.InsertVertices; }
        }

        /// <summary>
        /// Is the delete vertices map tool enabled
        /// </summary>
        public bool DeleteVerticesToolEnabled
        {
            get { return Controller?.SelectedMapToolType == MapToolType.DeleteVertices; }
        }

        /// <summary>
        /// Is the move vertices map tool enabled
        /// </summary>
        public bool MoveVerticesMapToolEnabled
        {
            get { return Controller?.SelectedMapToolType == MapToolType.MoveVertices; }
        }

        /// <summary>
        /// Is the delete edges map tool enabled
        /// </summary>
        public bool DeleteEdgesToolEnabled
        {
            get { return Controller?.SelectedMapToolType == MapToolType.DeleteEdges; }
        }
        ...
        [TypeConverter(typeof(EnumDescriptionAttributeTypeConverter))]
        public DeleteMeshOptions SelectedDeleteMeshOption
        {
        ...
        public void RefreshState()
        {
            ...
            OnPropertyChanged(nameof(DeleteVerticesToolEnabled));
            OnPropertyChanged(nameof(DeleteEdgesToolEnabled));
            OnPropertyChanged(nameof(MoveVerticesMapToolEnabled));

            OnPropertyChanged(nameof(ProjectToLandBoundaryOption));
            OnPropertyChanged(nameof(SelectedDeleteMeshOption));
            ...
            OnPropertyChanged(nameof(HasTwoPolygonsSelected));
        }
        ...
        private void SetCommands()
        {
            ...
            DeleteSamplesInPolygonsCommand = new RelayCommand(o => { Controller.DeleteSamplesInPolygons(); }, o => IsEditing);

            MergeVerticesCommand = new RelayCommand(o => { Controller.MergeVertices(); }, o => IsEditing);
            ...
            ClipPolygonsCommand = new RelayCommand(o => { Controller.ClipSelectedPolygons(); }, o => IsEditing && HasTwoPolygonsSelected);

            MergePolygonsCommand = new RelayCommand(o => { Controller.MergeSelectedPolygons(); }, o => IsEditing && HasTwoPolygonsSelected);

            SubtractPolygonsCommand = new RelayCommand(o => { Controller.SubtractSelectedPolygons(); }, o => IsEditing && HasTwoPolygonsSelected);
        ...
        private string GetFileFilter(ImportExportType importExportType)
        {
            switch (importExportType)
            {
                case ImportExportType.Grid:
                    return "Net file|*_net.nc|Map file|*.nc";
