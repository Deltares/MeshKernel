...
namespace meshkernel
{
    ...
    public:
        ...
        /// @brief Second order derivative at spline corner points (splint)
        /// @param[in] splines The spline corner points
        /// @returns coordinatesDerivatives The second order derivative at corner points
        static std::vector<Point> SecondOrderDerivative(const std::vector<Point>& splines);
        ...
        static std::vector<double> SecondOrderDerivative(const std::vector<double>& coordinates);
