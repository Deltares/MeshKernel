...
TEST(CurvilinearGridFromSplinesTransfinite, FourSplines)
{
    ...
    splines->AddSpline(fourthSpline, 0, static_cast<meshkernel::UInt>(fourthSpline.size()));
...
TEST(CurvilinearGridFromSplinesTransfinite, FiveSplines)
{
    ...
    splines->AddSpline(fifthSpline, 0, static_cast<meshkernel::UInt>(fifthSpline.size()));
