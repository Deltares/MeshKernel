...
TEST(CurvilinearGridSmoothing, Snapping)
{
    ...
    meshkernel::CurvilinearGridSnapping snapping2(mappedGrid2, westLandBoundary, snappingLine);
    ...
    snappingLine = std::vector{meshkernel::Point({0.000000e+00, 1.000000e+02}), meshkernel::Point({1.043040e+02, 9.715260e+01})};
    meshkernel::CurvilinearGridSnapping snapping3(mappedGrid3, northLandBoundary, snappingLine);
...
TEST(CurvilinearGridSmoothing, Snapping3)
{
