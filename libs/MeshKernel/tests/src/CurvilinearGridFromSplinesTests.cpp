...
TEST(CurvilinearGridFromSplines, CircularGrid)
{
    // Attempt to generate a grid with 4 splines forming a square
    // with the refinement factor being too high
    // Should raise a ConstraintError exception
    ...
    std::vector<mk::Point> spline0{{-30.0, 0.0},
                                   {30.0, 0.0}};

    std::vector<mk::Point> spline1{{1.1000e+02, 1.0000e+01},
                                   {4.0000e+01, 1.0000e+01},
                                   {3.0000e+01, 1.0000e+01},
                                   {2.6173e+01, 9.2388e+00},
                                   {2.2929e+01, 7.0711e+00},
                                   {2.0761e+01, 3.8268e+00},
                                   {2.0000e+01, 1.2246e-15},
                                   {2.0761e+01, -3.8268e+00},
                                   {2.2929e+01, -7.0711e+00},
                                   {2.6173e+01, -9.2388e+00},
                                   {3.0000e+01, -1.0000e+01},
                                   {4.0000e+01, -1.0000e+01},
                                   {1.1000e+02, -1.0000e+01}};

    std::vector<mk::Point> spline2{{-1.1000e+02, 1.0000e+01},
                                   {-4.0000e+01, 1.0000e+01},
                                   {-3.0000e+01, 1.0000e+01},
                                   {-2.6173e+01, 9.2388e+00},
                                   {-2.2929e+01, 7.0711e+00},
    ...
    std::vector<mk::Point> spline3{{1.0000e+02, 5.0000e+00},
                                   {9.2388e+01, 4.3268e+01},
                                   {7.0711e+01, 7.5711e+01},
                                   {3.8268e+01, 9.7388e+01},
                                   {6.1232e-15, 1.0500e+02},
                                   {-3.8268e+01, 9.7388e+01},
                                   {-7.0711e+01, 7.5711e+01},
                                   {-9.2388e+01, 4.3268e+01},
                                   {-1.0000e+02, 5.0000e+00}};

    std::vector<mk::Point> spline4{{1.0000e+02, -5.0000e+00},
                                   {9.2388e+01, -4.3268e+01},
                                   {7.0711e+01, -7.5711e+01},
                                   {3.8268e+01, -9.7388e+01},
                                   {6.1232e-15, -1.0500e+02},
    ...
    std::vector<mk::Point> spline5{{3.0000e+01, 5.0000e+00},
                                   {2.7716e+01, 1.6481e+01},
                                   {2.1213e+01, 2.6213e+01},
                                   {1.1481e+01, 3.2716e+01},
                                   {1.8370e-15, 3.5000e+01},
                                   {-1.1481e+01, 3.2716e+01},
                                   {-2.1213e+01, 2.6213e+01},
                                   {-2.7716e+01, 1.6481e+01},
                                   {-3.0000e+01, 5.0000e+00}};

    std::vector<mk::Point> spline6{{3.0000e+01, -5.0000e+00},
                                   {2.7716e+01, -1.6481e+01},
                                   {2.1213e+01, -2.6213e+01},
                                   {1.1481e+01, -3.2716e+01},
                                   {1.8370e-15, -3.5000e+01},
    ...
    std::vector<mk::Point> spline7{{4.0000e+01, 5.0000e+00},
                                   {3.6955e+01, 2.0307e+01},
                                   {2.8284e+01, 3.3284e+01},
                                   {1.5307e+01, 4.1955e+01},
                                   {2.4493e-15, 4.5000e+01},
                                   {-1.5307e+01, 4.1955e+01},
                                   {-2.8284e+01, 3.3284e+01},
                                   {-3.6955e+01, 2.0307e+01},
                                   {-4.0000e+01, 5.0000e+00}};

    std::vector<mk::Point> spline8{{4.0000e+01, -5.0000e+00},
                                   {3.6955e+01, -2.0307e+01},
                                   {2.8284e+01, -3.3284e+01},
                                   {1.5307e+01, -4.1955e+01},
                                   {2.4493e-15, -4.5000e+01},
    ...
    std::vector<mk::Point> spline9{{2.7136e+01, 5.0000e+00},
                                   {2.5070e+01, 1.0740e+01},
                                   {1.9188e+01, 1.5607e+01},
                                   {1.0385e+01, 1.8858e+01},
                                   {1.6616e-15, 2.0000e+01},
                                   {-1.0385e+01, 1.8858e+01},
                                   {-1.9188e+01, 1.5607e+01},
                                   {-2.5070e+01, 1.0740e+01},
                                   {-2.7136e+01, 5.0000e+00}};

    std::vector<mk::Point> spline10{{2.7136e+01, -5.0000e+00},
                                    {2.5070e+01, -1.0740e+01},
                                    {1.9188e+01, -1.5607e+01},
                                    {1.0385e+01, -1.8858e+01},
                                    {1.6616e-15, -2.0000e+01},
    ...
    auto splines = std::make_shared<Splines>(Projection::cartesian);
    splines->AddSpline(spline0);
    splines->AddSpline(spline1);
    splines->AddSpline(spline2);
    splines->AddSpline(spline3);
    splines->AddSpline(spline4);
    // splines->AddSpline(spline5);
    // splines->AddSpline(spline6);
    // splines->AddSpline(spline7);
    // splines->AddSpline(spline8);

    splines->AddSpline(spline9);
    splines->AddSpline(spline10);

    mk::CurvilinearParameters curvilinearParameters;
    mk::CurvilinearGridSplineToGrid splinesToGrid;

    curvilinearParameters.m_refinement = 30;
    curvilinearParameters.n_refinement = 10;

    auto grid = splinesToGrid.Compute(*splines, curvilinearParameters);
