...
TEST(CurvilinearGridFromSplines, ComputeBoundingBox)
{
    ...
    splines->AddSpline(thirdSpline, 0, static_cast<meshkernel::Index>(thirdSpline.size()));
    ...
    splines->AddSpline(fourthSpline, 0, static_cast<meshkernel::Index>(fourthSpline.size()));
...
TEST(CurvilinearGridFromSplines, OrthogonalCurvilinearGridFromSplineWithSevenSplies)
{
    ...
    splines->AddSpline(firstCentralSpline, 0, static_cast<meshkernel::Index>(firstCentralSpline.size()));

    std::vector<Point> secondCentralSpline{{1.310014E+02, 9.637659E+01},
                                           {2.960025E+02, 2.891285E+02},
                                           {6.222545E+02, 5.418811E+02}};
    splines->AddSpline(secondCentralSpline, 0, static_cast<meshkernel::Index>(secondCentralSpline.size()));

    std::vector<Point> thirdCentralSpline{{1.782517E+02, 5.662619E+01},
                                          {3.335027E+02, 2.448781E+02},
                                          {6.455046E+02, 4.983806E+02}};

    splines->AddSpline(thirdCentralSpline, 0, static_cast<meshkernel::Index>(thirdCentralSpline.size()));

    std::vector<Point> fourthBankSpline{{3.500084E+01, 1.901275E+02},
                                        {2.195020E+02, 3.813795E+02},
                                        {5.727542E+02, 6.221319E+02}};

    splines->AddSpline(fourthBankSpline, 0, static_cast<meshkernel::Index>(fourthBankSpline.size()));

    std::vector<Point> fifthBankSpline{{3.177526E+02, -3.712475E+01},
                                       {4.377534E+02, 1.218768E+02},
                                       {7.445052E+02, 4.136298E+02}};

    splines->AddSpline(fifthBankSpline, 0, static_cast<meshkernel::Index>(fifthBankSpline.size()));

    std::vector<Point> sixthBankSpline{{1.250633E+00, 2.748784E+02},
                                       {3.620029E+02, -3.337471E+01}};
    splines->AddSpline(sixthBankSpline, 0, static_cast<meshkernel::Index>(sixthBankSpline.size()));

    std::vector<Point> seventhBankSpline{{5.030038E+02, 6.476321E+02},
                                         {7.542553E+02, 3.378790E+02}};

    splines->AddSpline(seventhBankSpline, 0, static_cast<meshkernel::Index>(seventhBankSpline.size()));
...
TEST(CurvilinearGridFromSplines, Compute_ThreeLongitudinalSplinesTwoCrossingSplines_ShouldComputeMesh)
{
    ...
    splines->AddSpline(fifthSpline, 0, static_cast<meshkernel::Index>(fifthSpline.size()));
