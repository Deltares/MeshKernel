...
TEST(Mesh1D, GenerateMeshFromPolyLines_WithOverlappingNodes_ShouldRemoveOverlappingNodes)
{
    ...
    ASSERT_NEAR(meshkernel::constants::missing::doubleValue, mesh.m_nodes[2].x, tolerance);
    ASSERT_NEAR(15.0, mesh.m_nodes[3].x, tolerance);
    ...
    ASSERT_NEAR(meshkernel::constants::missing::doubleValue, mesh.m_nodes[2].y, tolerance);
    ...
    ASSERT_NEAR(-5.0, mesh.m_nodes[6].y, tolerance);
    ASSERT_NEAR(0.0, mesh.m_nodes[7].y, tolerance);
    ASSERT_NEAR(5.0, mesh.m_nodes[8].y, tolerance);
