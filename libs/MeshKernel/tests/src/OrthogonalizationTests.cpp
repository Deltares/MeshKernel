...
TEST(OrthogonalizationAndSmoothing, OrthogonalizationOneQuadOneTriangle)
{
    ...
    const auto projectToLandBoundaryOption = SnappingMesh2DToLandBoundariesCalculator::ProjectionsOptions::DoNotProject;
    ...
    auto landboundaries = std::make_unique<SnappingMesh2DToLandBoundariesCalculator>(landBoundary, mesh, *polygon);
...
TEST(OrthogonalizationAndSmoothing, OrthogonalizeAndSnapToLandBoundaries)
{
    ...
    const auto projectToLandBoundaryOption = SnappingMesh2DToLandBoundariesCalculator::ProjectionsOptions::OuterMeshBoundaryToLandBoundaries;
    OrthogonalizationParameters orthogonalizationParameters;
    orthogonalizationParameters.outer_iterations = 2;
    orthogonalizationParameters.boundary_iterations = 25;
    orthogonalizationParameters.inner_iterations = 25;
...
TEST(OrthogonalizationAndSmoothing, OrthogonalizationWithGapsInNodeAndEdgeLists)
{
    ...
    std::unique_ptr<SnappingMesh2DToLandBoundariesCalculator> boundary = std::make_unique<SnappingMesh2DToLandBoundariesCalculator>(refinedPolygonPoints, mesh, *refinedPolygon);
