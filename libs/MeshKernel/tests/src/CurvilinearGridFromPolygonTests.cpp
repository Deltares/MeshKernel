...
TEST(CurvilinearGridFromPolygon, ComputeGridInPolygonWithFourthSide)
{
    ...
    ASSERT_NEAR(305.00253300000003, curvilinearGrid->GetNode(1, 0).x, tolerance);
    ASSERT_NEAR(507.50378400000000, curvilinearGrid->GetNode(2, 0).x, tolerance);

    ASSERT_NEAR(478.88043199999998, curvilinearGrid->GetNode(0, 0).y, tolerance);
    ASSERT_NEAR(493.13061499999998, curvilinearGrid->GetNode(1, 0).y, tolerance);
    ASSERT_NEAR(494.63061499999998, curvilinearGrid->GetNode(2, 0).y, tolerance);

    ASSERT_NEAR(274.25231900000000, curvilinearGrid->GetNode(0, 1).x, tolerance);
    ASSERT_NEAR(410.51616175207897, curvilinearGrid->GetNode(1, 1).x, tolerance);
    ASSERT_NEAR(741.50524900000005, curvilinearGrid->GetNode(2, 1).x, tolerance);

    ASSERT_NEAR(325.12890599999997, curvilinearGrid->GetNode(0, 1).y, tolerance);
    ASSERT_NEAR(314.33420290273324, curvilinearGrid->GetNode(1, 1).y, tolerance);
    ASSERT_NEAR(328.12893700000001, curvilinearGrid->GetNode(2, 1).y, tolerance);
}
...
TEST(CurvilinearGridFromPolygon, ComputeGridInPolygonWithoutFourthSide)
{
    ...
    ASSERT_NEAR(273.50231900000000, curvilinearGrid->GetNode(0, 0).x, tolerance);
    ASSERT_NEAR(492.12869250000006, curvilinearGrid->GetNode(1, 0).x, tolerance);
    ASSERT_NEAR(710.75506600000006, curvilinearGrid->GetNode(2, 0).x, tolerance);

    ASSERT_NEAR(478.88043199999998, curvilinearGrid->GetNode(0, 0).y, tolerance);
    ASSERT_NEAR(484.88049300000000, curvilinearGrid->GetNode(1, 0).y, tolerance);
    ASSERT_NEAR(490.88055400000002, curvilinearGrid->GetNode(2, 0).y, tolerance);
...
TEST(CurvilinearGridFromPolygon, ComputeGridTriangle)
{
    ...
    ASSERT_NEAR(558.64300500000002, curvilinearGrid->GetNode(1, 0).x, tolerance);
    ASSERT_NEAR(593.41625999999997, curvilinearGrid->GetNode(2, 0).x, tolerance);

    ASSERT_NEAR(437.15594499999997, curvilinearGrid->GetNode(0, 0).y, tolerance);
    ASSERT_NEAR(324.65368699999999, curvilinearGrid->GetNode(1, 0).y, tolerance);
    ASSERT_NEAR(266.56158399999998, curvilinearGrid->GetNode(2, 0).y, tolerance);

    ASSERT_NEAR(427.73178100000001, curvilinearGrid->GetNode(0, 1).x, tolerance);
    ASSERT_NEAR(473.00523900000007, curvilinearGrid->GetNode(1, 1).x, tolerance);
    ASSERT_NEAR(528.77893099999994, curvilinearGrid->GetNode(2, 1).x, tolerance);

    ASSERT_NEAR(382.74575800000002, curvilinearGrid->GetNode(0, 1).y, tolerance);
    ASSERT_NEAR(322.06271366666670, curvilinearGrid->GetNode(1, 1).y, tolerance);
    ASSERT_NEAR(263.28878800000001, curvilinearGrid->GetNode(2, 1).y, tolerance);
}
