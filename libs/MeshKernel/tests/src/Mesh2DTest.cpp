...
TEST(Mesh2D, WTF)
{
    const meshkernel::UInt size = 4001;
    const double dimension = 4000.0;
    ...
    double startInterval = 999.5;
    double endInterval = 1010.5;

    //
    std::vector<meshkernel::Point> polygonPoints{{startInterval, startInterval}, {endInterval, startInterval}, {endInterval, endInterval}, {startInterval, endInterval}, {startInterval, startInterval}};
    ...
    for (int i = 1; i <= 10; ++i)
    {
        double minLength = mesh->ComputeMinEdgeLength(polygon);
    ...
    std::cout << " elapsedTime member " << elapsedTime << std::endl;
    ...
    for (int i = 1; i <= 10; ++i)
    {
        ...
        double minLength = meshkernel::MeshEdgeLength::MinEdgeLength(*mesh, polygon, edgeLengths);
    ...
    std::cout << " elapsedTime class  " << elapsedTime << std::endl;
    start = std::chrono::high_resolution_clock::now();
