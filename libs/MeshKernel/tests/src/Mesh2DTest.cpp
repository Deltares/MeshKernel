...
TEST(Mesh2D, Mesh2DComputeAspectRatio)
{
    ...
    std::vector<double> expectedAspectRatios{0.90536736226953, 1.3740745583444, 1.0795001217843,
                                             0.89577932787173, 0.83957931754859, 1.1571181671668,
                                             0.82907839896639, 0.8184465336627, 1.1207763529917,
                                             0.80734631273275, 0.96961508287001, 1.1818738356844};
...
TEST(Mesh2D, CircumcentreTest)
{
    ...
    std::vector<double> expectedCentresX{206.66045181776, 185.88899548513, 276.04546192092, 262.10377308169,
                                         351.51254726036, 354.4883368202, 96.896321572911, 74.139465907719,
                                         64.951930887175, 26.519385077921, 143.78092304317, 126.14027270258,
                                         119.14010559704, 95.225685348389, 195.26966342471, 194.97207774674,
                                         196.668564065, 253.03016243185, 277.72624851155, 305.99317737015,
                                         327.07838431315, 347.45615465742, 376.69408855847};

    std::vector<double> expectedCentresY{416.30029070554, 420.1048414297, 368.79110625897, 390.31277822052,
                                         283.46192219589, 288.01089790241, 267.18219001356, 275.57145773118,
                                         279.58962615293, 293.86514302815, 368.40527072909, 380.31480851501,
                                         387.67531824066, 416.01620194071, 399.08509297977, 430.10656312963,
                                         477.61119952542, 365.19932335134, 387.97031178493, 417.96409302328,
                                         266.71546313086, 280.53273931154, 300.70729479362};
...
TEST(Mesh2D, ComputeEdgeNetlinkContourPolygonsSpherical)
{
    auto mesh = MakeRectangularMeshForTesting(3, 3, 2.0, 2.0, meshkernel::Projection::spherical, {0.0, 0.0}, true, false, 45.0 /* degrees */);
    mesh->Administrate();
    ...
    // Select a small number of edges to check
    std::vector<size_t> edgesToTest{0, 1, 4, 9};

    std::vector<double> expectedXs{0.35347261675579, -0.3536072339909, 0.0, 0.70710678118655,
                                   -0.3535079537867, 0.35367963115804, -0.35386318152916, -1.0608891170225,
                                   0.35391709418889, 1.0611587071825, 0.35334626129143, -0.35362579906273,
                                   -1.0611587100728, -0.35391709707802, 0.35362580258488, -0.35334625776794};

    std::vector<double> expectedYs{1.0607005509829, 0.35359376979639, 0.0, 0.70710678118655,
                                   0.35365603487481, 1.0607628160614, 1.7678477402708, 1.0607409590842,
                                   1.0607409666446, 1.7678477478311, 2.474502010011, 1.7673952288245,
                                   1.7678477449456, 1.0607409637591, 1.7673952323422, 2.4745020135288};
