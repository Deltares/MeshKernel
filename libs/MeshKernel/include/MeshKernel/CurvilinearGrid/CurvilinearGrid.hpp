...
namespace meshkernel
{
    ...
    public:
        ...
        std::tuple<int, UndoActionPtr> AddGridLinesAtBoundary(CurvilinearGridNodeIndices const& firstNode, CurvilinearGridNodeIndices const& secondNode, int numLines);
