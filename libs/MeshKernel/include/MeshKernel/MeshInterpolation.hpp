...
namespace meshkernel
{
    ...
    public:
        ...
        [[nodiscard]] double GetNodeResult(UInt node) const { return m_nodeResults[node]; }

        /// @brief Gets the interpolation value at a specific edge
        /// @param[in] edge The edge index
        /// @return The interpolated value
        [[nodiscard]] double GetEdgeResult(UInt edge) const { return m_edgeResults[edge]; }

        /// @brief Gets the interpolation value at a specific face
        /// @param[in] face The face index
        /// @return  The interpolated value
        [[nodiscard]] double GetFaceResult(UInt face) const { return m_faceResults[face]; }
