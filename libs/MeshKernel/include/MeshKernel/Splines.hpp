...
namespace meshkernel
{
    ...
    public:
        ...
        /// @returns The points along the spline and the adimensional distances of each point
        ...
        /// @param[in] whichSpline Spline index
        /// @param[in] lambda The adimensinal coordinate where to perform the interpolation
        ...
        /// @brief Get the size of a specific spline
    ...
    struct FuncAdimensionalToDimensionalDistanceOnSpline
    {
        ...
        const Splines& m_spline;            ///< Reference to splines
