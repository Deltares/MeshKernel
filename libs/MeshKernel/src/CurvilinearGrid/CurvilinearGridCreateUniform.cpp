...
namespace meshkernel
{
    ...
    lin_alg::MatrixRowMajor<Point> CurvilinearGridCreateUniform::ComputeCartesian(const int numColumns,
                                                                                  const int numRows,
                                                                                  const double originX,
                                                                                  const double originY,
                                                                                  const double angle,
...

    {
        ...
        lin_alg::MatrixRowMajor<Point> result(numN, numM);
    ...
    lin_alg::MatrixRowMajor<Point> CurvilinearGridCreateUniform::ComputeSpherical(const int numColumns,
                                                                                  const int numRows,
                                                                                  const double originX,
                                                                                  const double originY,
                                                                                  const double angle,
                                                                                  ...
                                                                                  const double blockSizeY)
    {
        ...
        auto result = ComputeCartesian(numColumns,
                                       numRows,
                                       originX,
                                       originY,
                                       angle,
