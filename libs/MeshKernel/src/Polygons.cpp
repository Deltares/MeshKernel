                                                            ...
                                                            double refinementDistance) const
{
    ...
    const size_t numNodesRefinedPart = static_cast<size_t>(std::ceil((nodeLengthCoordinate[endIndex] - nodeLengthCoordinate[startIndex]) / refinementDistance)) + endIndex - startIndex;
