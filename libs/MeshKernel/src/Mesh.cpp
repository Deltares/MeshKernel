...
namespace meshkernel
{
    ...
    Mesh::Mesh(const std::vector<Edge>& edges,
        ...
        : m_nodes(nodes), m_edges(edges), m_projection(projection)
    {
    }
    ...
    RTree const& Mesh::GetTree(Location location) const
    {
        switch (location)
        {
        case Location::Faces:
        ...
        case Location::Unknown:
        default:
            throw std::runtime_error("Mesh::GetTree: Invalid lcoation.");
        }
    }
