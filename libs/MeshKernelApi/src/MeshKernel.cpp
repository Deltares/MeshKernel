...
namespace meshkernelapi
{
    ...
    MKERNEL_API int mkernel_mesh2d_snap_to_landboundary(int meshKernelId, const GeometryList& selectingPolygon, const GeometryList& landBoundaries)
    {
        ...
        try
        {
            ...
            auto landBoundary = meshkernel::SnappingMesh2DToLandBoundariesCalculator(landBoundariesPoints, *meshKernelState[meshKernelId].m_mesh2d, polygon);
                                                             ...
                                                             const GeometryList& landBoundaries)
    {
        ...
        try
        {
            ...
            auto landBoundary = std::make_unique<meshkernel::SnappingMesh2DToLandBoundariesCalculator>(landBoundariesPoints, *meshKernelState[meshKernelId].m_mesh2d, *polygon);
            ...
            meshkernel::OrthogonalizationAndSmoothing ortogonalization(*meshKernelState[meshKernelId].m_mesh2d,
                                                                       ...
                                                                       static_cast<meshkernel::SnappingMesh2DToLandBoundariesCalculator::ProjectionsOptions>(projectToLandBoundaryOption),
                                                                ...
                                                                const GeometryList& landBoundaries)
    {
        ...
        try
        {
            ...
            auto landBoundary = std::make_unique<meshkernel::SnappingMesh2DToLandBoundariesCalculator>(landBoundariesNodeVector, *meshKernelState[meshKernelId].m_mesh2d, *polygon);
                                              ...
                                              const GeometryList& landBoundaries)
    {
        ...
        try
        {
            ...
            auto landBoundary = meshkernel::SnappingMesh2DToLandBoundariesCalculator(landBoundariesNodeVector, *meshKernelState[meshKernelId].m_mesh2d, polygon);
