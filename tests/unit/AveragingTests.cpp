...
{
    std::vector<meshkernel::Sample> samples = ReadSampleFile("..\\data\\AveragingInterpolationTests\\inTestAveragingInterpolation.xyz");
    auto mesh = ReadLegacyMeshFromFile("..\\data\\AveragingInterpolationTests\\simple_grid_net.nc");
...
{
    std::vector<meshkernel::Sample> samples = ReadSampleFile("..\\data\\AveragingInterpolationTests\\inTestAveragingInterpolation.xyz");
    auto mesh = ReadLegacyMeshFromFile("..\\data\\AveragingInterpolationTests\\sample_grid_coarse_net.nc");
    ASSERT_GT(mesh->GetNumNodes(), 0);
