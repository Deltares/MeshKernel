...
TEST(CurvilinearLineMirror, Compute_OnMGridlineShiftingOneNode_ShouldShiftLine)
{
    ...
    meshkernel::CurvilinearGridLineMirror curvilinearLineMirror(curvilinearGrid);
    curvilinearLineMirror.SetLine({79982.0, 366934.0}, {80155.0, 366530.0});
    curvilinearLineMirror.SetBlock({80108.0, 366707.0}, {80291.0, 366792.0});
