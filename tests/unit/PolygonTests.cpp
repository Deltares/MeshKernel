...
TEST(Polygons, MeshBoundaryToPolygon)
{
    ...
    ASSERT_NEAR(meshkernel::constants::missing::doubleValue, meshBoundaryPolygon[8].x, tolerance);
    ...
    ASSERT_NEAR(meshkernel::constants::missing::doubleValue, meshBoundaryPolygon[8].y, tolerance);
}
