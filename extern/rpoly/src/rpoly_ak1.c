...
void Fxshfr_ak1(int L2, int* NZ, double sr, double bnd, double K[MAX_RPOLY_DEGREE_P1], int N, double p[MAX_RPOLY_DEGREE_P1], int NN, double qp[MAX_RPOLY_DEGREE_P1], double* lzi, double* lzr, double* szi, double* szr);
void QuadSD_ak1(int NN, double u, double v, double p[MAX_RPOLY_DEGREE_P1], double q[MAX_RPOLY_DEGREE_P1], double* a, double* b);
int calcSC_ak1(int N, double a, double b, double* a1, double* a3, double* a7, double* c, double* d, double* e, double* f, double* g, double* h, double K[MAX_RPOLY_DEGREE_P1], double u, double v, double qk[MAX_RPOLY_DEGREE_P1]);
void nextK_ak1(int N, int tFlag, double a, double b, double a1, double* a3, double* a7, double K[MAX_RPOLY_DEGREE_P1], double qk[MAX_RPOLY_DEGREE_P1], double qp[MAX_RPOLY_DEGREE_P1]);
void newest_ak1(int tFlag, double* uu, double* vv, double a, double a1, double a3, double a7, double b, double c, double d, double f, double g, double h, double u, double v, double K[MAX_RPOLY_DEGREE_P1], int N, double p[MAX_RPOLY_DEGREE_P1]);
void QuadIT_ak1(int N, int* NZ, double uu, double vv, double* szr, double* szi, double* lzr, double* lzi, double qp[MAX_RPOLY_DEGREE_P1], int NN, double* a, double* b, double p[MAX_RPOLY_DEGREE_P1], double qk[MAX_RPOLY_DEGREE_P1], double* a1, double* a3, double* a7, double* d, double* e, double* f, double* g, double* h, double K[MAX_RPOLY_DEGREE_P1]);
void RealIT_ak1(int* iFlag, int* NZ, double* sss, int N, double p[MAX_RPOLY_DEGREE_P1], int NN, double qp[MAX_RPOLY_DEGREE_P1], double* szr, double* szi, double K[MAX_RPOLY_DEGREE_P1], double qk[MAX_RPOLY_DEGREE_P1]);
...
void Fxshfr_ak1(int L2, int* NZ, double sr, double bnd, double K[MAX_RPOLY_DEGREE_P1], int N, double p[MAX_RPOLY_DEGREE_P1], int NN, double qp[MAX_RPOLY_DEGREE_P1], double* lzi, double* lzr, double* szi, double* szr)
{
  ...
  double qk[MAX_RPOLY_DEGREE_P1], svk[MAX_RPOLY_DEGREE_P1];
               ...
               double zeroi [MAX_RPOLY_DEGREE])
{
  ...
  double K[MAX_RPOLY_DEGREE_P1], p[MAX_RPOLY_DEGREE_P1], pt[MAX_RPOLY_DEGREE_P1], qp[MAX_RPOLY_DEGREE_P1], temp[MAX_RPOLY_DEGREE_P1];
