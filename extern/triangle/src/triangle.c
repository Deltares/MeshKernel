...
#define decode(ptr, otri)                                                     \
  (otri).orient = (int) ((unsigned long long) (ptr) & (unsigned long long) 3llu);         \
  (otri).tri = (triangle *)                                                   \
...
#define infect(otri)                                                          \
  (otri).tri[6] = (triangle)                                                  \
                    ((unsigned long long) (otri).tri[6] | (unsigned long long) 2ull)
...
#define infected(otri)                                                        \
  (((unsigned long long) (otri).tri[6] & (unsigned long long) 2ull) != 0ull)
...
#define sdecode(sptr, osub)                                                   \
  (osub).ssorient = (int) ((unsigned long long) (sptr) & (unsigned long long) 1ull);      \
  (osub).ss = (subseg *)                                                      \
              ((unsigned long long) (sptr) & ~ (unsigned long long) 3ull)
