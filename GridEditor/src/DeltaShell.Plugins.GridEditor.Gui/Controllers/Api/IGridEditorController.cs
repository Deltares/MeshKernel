...
namespace DeltaShell.Plugins.GridEditor.Gui.Controllers.Api
{
    internal interface IGridEditorController
    {
        ...
        /// <summary>
        /// Has one or more selected vertices
        /// </summary>
        bool HasSelectedVertices { get; }
        ...
        /// Merge two neighboring vertices  
        /// </summary>
        void MergeTwoVertices();
        ...
        /// </summary>
        void MakeGridFromSplinesOrthogonal();
