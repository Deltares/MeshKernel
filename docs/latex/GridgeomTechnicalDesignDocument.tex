...
\begin{figure}[H]
	\centering
	\includegraphics*[width=1.0\textwidth]{pictures/MeshKernelClassDiagram_1.jpg}
...
\begin{figure}[H]
	\centering
	\includegraphics*[width=1.0\textwidth]{pictures/sequence_diagram_refinement.jpg}
...
\begin{figure}[H]
	\begin{center}
		...
		\resizebox{0.45\textwidth}{!}{
			\input{pictures/coincide_circumcentre.pdf_tex}
		}
	\end{center}
...
\item The ratio of the face area to the average area of neighboring non triangles is less than a minimum ratio (default to 0.2)
...
\begin{figure}[H]
	\centering
	\includegraphics*[width=1.0\textwidth]{pictures/sequence_diagram_orthogonalization.jpg}
