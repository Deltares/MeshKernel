                                                     ...
                                                     CurvilinearGrid& curvilinearGrid) const
{
    ...
    {
        throw std::invalid_argument("CurvilinearGridFromPolygon: The polygon contains no nodes.");
    }
    ...
    if (!areNodesValid)
    {
        throw std::invalid_argument("CurvilinearGridFromPolygon: Invalid nodes.");
    }
    ...
    {
        throw std::invalid_argument("CurvilinearGridFromPolygon: The polygon does not contain enough nodes to compute the curvilinear grid.");
    }
                                                     ...
                                                     CurvilinearGrid& curvilinearGrid) const
{
    ...
    if (n1 < 1 || n2 < 1 || n3 < 1)
    {
        throw std::invalid_argument("CurvilinearGridFromPolygon: The block size is less than the number of points.");
    }
