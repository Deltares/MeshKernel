...
TEST(OrthogonalizationTest, TestOrthogonalizationMediumTriangularGrid)
{
...
TEST(OrthogonalizationTest, TestOrthogonalizationLargeTriangularGridAndMeasureRuntime)
{
